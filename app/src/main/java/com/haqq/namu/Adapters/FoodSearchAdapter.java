...
public class FoodSearchAdapter extends RecyclerView.Adapter<FoodSearchAdapter.MyViewHolder> {
    FoodSearchActivity context;
    public List<Foods> coursesList;
    public DetailsAdapterListener onClickListener;


    public FoodSearchAdapter(List<Foods> coursesList, FoodSearchActivity context, DetailsAdapterListener listener) {
        super();
