...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener , OnMapReadyCallback, TaskLoadedCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.map_tacking);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition googlePlex = CameraPosition.builder()
                .target(new LatLng(11.9714602,8.5570989))
                .zoom(7)
                .bearing(0)
                .tilt(45)
                .build();
...
//            mylangt = Integer.parseInt(intent.getStringExtra("langt"));
//            mylongt = Integer.parseInt(intent.getStringExtra("longt"));


            place1 = new MarkerOptions().position(new LatLng(location.getLatitude(), location.getLongitude())).title("Starting Point");
            place2 = new MarkerOptions().position(new LatLng(11.9864671, 8.5334031)).title("My Destination");
